...
```{r}
demo.lme<-lme(arcProp.developing.corr.authors~Predatory.,random=~1|Journal,data=demographic)
anova(demo.lme)
```
```{r}
demo.gls<-gls(arcProp.developing.corr.authors~Predatory.,data=demographic)
...
```{r}
demo2.lme<-lme(arcProp.developing.other.authors~Predatory.,random=~1|Journal,data=demographic)
anova(demo2.lme)
```

```{r}
demo3.gls<-gls(arcProp.developing.other.authors~Predatory.,data=demographic)
